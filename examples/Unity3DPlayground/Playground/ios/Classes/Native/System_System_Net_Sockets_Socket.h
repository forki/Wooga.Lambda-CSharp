...
struct Socket_t1576  : public Object_t
{
	...
	Thread_t1588 * ___blocking_thread_13;
	...
	EndPoint_t1581 * ___seed_endpoint_20;
};
struct Socket_t1576_StaticFields{
	...
	MethodInfo_t1265 * ___check_socket_policy_21;
};
