...
struct X509EnhancedKeyUsageExtension_t1720  : public X509Extension_t1700
{
	...
	OidCollection_t1718 * ____enhKeyUsage_4;
...
struct X509EnhancedKeyUsageExtension_t1720_StaticFields{
	...
	Dictionary_2_t1162 * ___U3CU3Ef__switch$mapE_6;
};
