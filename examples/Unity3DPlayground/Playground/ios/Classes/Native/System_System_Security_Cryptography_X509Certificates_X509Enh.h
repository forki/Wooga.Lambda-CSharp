...
struct X509EnhancedKeyUsageExtension_t3046  : public X509Extension_t3025
{
	...
	OidCollection_t3044 * ____enhKeyUsage_4;
...
struct X509EnhancedKeyUsageExtension_t3046_StaticFields{
	...
	Dictionary_2_t2522 * ___U3CU3Ef__switch$mapE_6;
};
