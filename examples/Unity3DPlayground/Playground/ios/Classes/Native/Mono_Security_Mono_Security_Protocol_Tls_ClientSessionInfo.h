...
struct ClientSessionInfo_t1965  : public Object_t
{
	...
	DateTime_t1141  ___validuntil_2;
	...
	ByteU5BU5D_t1071* ___sid_4;
	// System.Byte[] Mono.Security.Protocol.Tls.ClientSessionInfo::masterSecret
	ByteU5BU5D_t1071* ___masterSecret_5;
};
struct ClientSessionInfo_t1965_StaticFields{
