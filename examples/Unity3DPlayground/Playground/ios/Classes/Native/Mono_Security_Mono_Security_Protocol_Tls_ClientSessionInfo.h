...
struct ClientSessionInfo_t3311  : public Object_t
{
	...
	DateTime_t2501  ___validuntil_2;
	...
	ByteU5BU5D_t961* ___sid_4;
	// System.Byte[] Mono.Security.Protocol.Tls.ClientSessionInfo::masterSecret
	ByteU5BU5D_t961* ___masterSecret_5;
};
struct ClientSessionInfo_t3311_StaticFields{
