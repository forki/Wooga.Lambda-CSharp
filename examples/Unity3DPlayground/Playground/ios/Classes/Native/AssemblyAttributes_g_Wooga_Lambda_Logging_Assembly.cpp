...
void g_Wooga_Lambda_Logging_Assembly_CustomAttributesCacheGenerator(CustomAttributesCache* cache)
{
	cache->attributes = (Il2CppObject**)il2cpp_gc_alloc_fixed(sizeof(Object_t *) * cache->count, 0);
	{
		...
		InternalsVisibleToAttribute__ctor_m2914(tmp, il2cpp_codegen_string_new_wrapper("Wooga.Lambda.Logging.Tests"), &InternalsVisibleToAttribute__ctor_m2914_MethodInfo);
	...
	}
	{
		...
		AssemblyTitleAttribute__ctor_m2452(tmp, il2cpp_codegen_string_new_wrapper("Wooga.Lambda.Logging"), &AssemblyTitleAttribute__ctor_m2452_MethodInfo);
...
CustomAttributesCache g_Wooga_Lambda_Logging_Assembly__CustomAttributeCache = {
8,
NULL,
&g_Wooga_Lambda_Logging_Assembly_CustomAttributesCacheGenerator
};
