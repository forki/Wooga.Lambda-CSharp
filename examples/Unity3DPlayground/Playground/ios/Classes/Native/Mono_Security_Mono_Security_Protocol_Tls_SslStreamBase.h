...
struct SslStreamBase_t1570  : public Stream_t1049
{
	...
	ManualResetEvent_t624 * ___negotiationComplete_13;
	// System.Byte[] Mono.Security.Protocol.Tls.SslStreamBase::recbuf
	ByteU5BU5D_t1071* ___recbuf_14;
	// System.IO.MemoryStream Mono.Security.Protocol.Tls.SslStreamBase::recordStream
	MemoryStream_t1679 * ___recordStream_15;
};
struct SslStreamBase_t1570_StaticFields{
	...
	ManualResetEvent_t624 * ___record_processing_2;
};
