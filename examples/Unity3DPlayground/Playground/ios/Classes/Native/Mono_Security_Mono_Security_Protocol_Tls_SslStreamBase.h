...
struct SslStreamBase_t3335  : public Stream_t3308
{
	...
	ManualResetEvent_t606 * ___negotiationComplete_13;
	// System.Byte[] Mono.Security.Protocol.Tls.SslStreamBase::recbuf
	ByteU5BU5D_t961* ___recbuf_14;
	// System.IO.MemoryStream Mono.Security.Protocol.Tls.SslStreamBase::recordStream
	MemoryStream_t3338 * ___recordStream_15;
};
struct SslStreamBase_t3335_StaticFields{
	...
	ManualResetEvent_t606 * ___record_processing_2;
};
