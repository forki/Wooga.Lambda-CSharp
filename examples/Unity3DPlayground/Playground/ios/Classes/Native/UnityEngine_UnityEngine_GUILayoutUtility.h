...
struct GUILayoutUtility_t2508  : public Object_t
{
};
struct GUILayoutUtility_t2508_StaticFields{
	...
	Dictionary_2_t2507 * ___storedLayouts_0;
	...
	Dictionary_2_t2507 * ___storedWindows_1;
	// UnityEngine.GUILayoutUtility/LayoutCache UnityEngine.GUILayoutUtility::current
	LayoutCache_t2506 * ___current_2;
	// UnityEngine.Rect UnityEngine.GUILayoutUtility::kDummyRect
	Rect_t276  ___kDummyRect_3;
	// UnityEngine.GUIStyle UnityEngine.GUILayoutUtility::s_SpaceStyle
	GUIStyle_t2502 * ___s_SpaceStyle_4;
};
