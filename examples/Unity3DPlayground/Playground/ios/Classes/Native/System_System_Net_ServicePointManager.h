...
struct ServicePointManager_t3006  : public Object_t
{
};
struct ServicePointManager_t3006_StaticFields{
	// System.Collections.Specialized.HybridDictionary System.Net.ServicePointManager::servicePoints
	HybridDictionary_t2962 * ___servicePoints_0;
	...
	RemoteCertificateValidationCallback_t2991 * ___server_cert_cb_9;
};
