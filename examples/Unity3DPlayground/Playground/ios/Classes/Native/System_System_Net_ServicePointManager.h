...
struct ServicePointManager_t1672  : public Object_t
{
};
struct ServicePointManager_t1672_StaticFields{
	// System.Collections.Specialized.HybridDictionary System.Net.ServicePointManager::servicePoints
	HybridDictionary_t1536 * ___servicePoints_0;
	...
	RemoteCertificateValidationCallback_t1571 * ___server_cert_cb_9;
};
