...
struct X509Store_t3039  : public Object_t
{
	...
	X509Certificate2Collection_t3029 * ___list_2;
	...
	X509Store_t3054 * ___store_4;
};
struct X509Store_t3039_StaticFields{
	...
	Dictionary_2_t2522 * ___U3CU3Ef__switch$mapF_5;
};
