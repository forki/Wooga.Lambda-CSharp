...
struct X509Store_t1713  : public Object_t
{
	...
	X509Certificate2Collection_t1703 * ___list_2;
	...
	X509Store_t1728 * ___store_4;
};
struct X509Store_t1713_StaticFields{
	...
	Dictionary_2_t1162 * ___U3CU3Ef__switch$mapF_5;
};
