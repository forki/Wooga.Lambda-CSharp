...
struct ComponentListPool_t396  : public Object_t
{
};
struct ComponentListPool_t396_StaticFields{
	...
	ObjectPool_1_t394 * ___s_ComponentListPool_0;
	...
	UnityAction_1_t395 * ___U3CU3Ef__am$cache1_1;
};
